...
![A picture containing knife, table Description automatically
generated](media/image2.jpg){width="6.373611111111111in"
...
*If those links don't work for you, the best way to access the online
...
+----------------------------------+----------------------------------+
| EBC (Edinburgh Birth Cohort)     | DART cameras                     |
| Cameras                          |                                  |
+==================================+==================================+
| There are **two** EBC cameras.   | There are **two** DART cameras   |
| These are labelled camera A and  |                                  |
| camera B                         | These cameras are currently      |
|                                  | located in the cabinet in Maggi  |
| These cameras are currently      | and Natalie's office.            |
| located in the bookcase near     |                                  |
| Lorna's desk                     | Before you take the camera make  |
|                                  | sure that you are also taking    |
| Please do not take the EBC       | the appropriate charger, USB     |
| cameras for anything outside of  | cord and any SD cards you need   |
| the EBC                          |                                  |
|                                  | Please also sign out the camera  |
| Before you take the camera make  | + tripods on the box and sign    |
| sure that you are also taking    | back in when returned            |
| the appropriate charger, USB     |                                  |
| cord and any SD cards you need   | Before returning the camera make |
|                                  | sure that:                       |
| Before returning the camera make |                                  |
| sure that:                       | 1.  The camera is fully charged  |
|                                  |                                  |
| 1.  The camera is fully charged  | 2.  The SD card inside the       |
|                                  |     camera is wiped of any and   |
| 2.  The SD card inside the       |     all recordings               |
|     camera is wiped of any and   |                                  |
|     all recordings               | 3.  All appropriate cords        |
|                                  |     (chargers and USB are        |
| 3.  All appropriate cords        |     returned along with the      |
|     (chargers and USB are        |     camera)                      |
|     returned along with the      |                                  |
|     camera)                      | 4.  The camera is being returned |
|                                  |     to exactly where you found   |
| 4.  The camera is being returned |     it                           |
|     to exactly where you found   |                                  |
|     it                           |                                  |
+----------------------------------+----------------------------------+
